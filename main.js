        ...
        return next.handle(req).pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (error) {
            ...
            if (error instanceof ErrorEvent) {
                ...
                if (error.error != undefined && error.error.mensaje) {
                    ...
                    console.error("Server-side error: " + error.error.codigo + " " + error.error.mensaje);
                }
                else {
...
var ServiceService = /** @class */ (function () {
        ...
        if (this.useMockups) {
            ...
            if (filtrosTurnos.os != undefined || filtrosTurnos.ep != undefined || filtrosTurnos.fecha != undefined) {
                ...
                if (filtrosTurnos.os != undefined) {
                    endpoint = endpoint + "/codOS=" + filtrosTurnos.os;
                    addAmp = true;
                }
    ...
    ServiceService.prototype.asignarTurno = function (codigoTurno) {
        if (this.useMockups) {
            return Object(_utils_service_utils__WEBPACK_IMPORTED_MODULE_5__["getWsFromMock"])(_mocks_mocks__WEBPACK_IMPORTED_MODULE_4__["rtaError"]);
        }
        else {
    ...
    ServiceService.prototype.confirmarTurno = function (confirmaTurno) {
        if (this.useMockups) {
            return Object(_utils_service_utils__WEBPACK_IMPORTED_MODULE_5__["getWsFromMock"])(_mocks_mocks__WEBPACK_IMPORTED_MODULE_4__["rtaOk"]);
        }
        else {
...
var _turnoReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_actions_turno_actions__WEBPACK_IMPORTED_MODULE_2__["clear"], function () { return initialState; }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_actions_turno_actions__WEBPACK_IMPORTED_MODULE_2__["setObraSocialSelected"], function (state, _a) {
    ...
    var confirmacion = _a.confirmacion;
    return _setConfirmacion(state, confirmacion);
}));
var _setObraSocialSelected = function (state, obraSocialSelected) {
    var stateNew = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, state);
    stateNew.obraSocialSelected = obraSocialSelected;
...
/*!*********************************************************!*\
  !*** ./src/app/core/store/selectors/turno.selectors.ts ***!
  \*********************************************************/
/*! exports provided: selectFormularioTurno, selectObraSocialSelected, selectTurnoSelected, selectTurnoRecuperado, alertaCambioEstadoTurnoSeleccionado, reqAsignarTurno, selectPacientesFiltrados, selectFiltroPacientes, selectPacienteSelected, selectRespuesta */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".popupTitle {\r\n  margin-bottom: 0px;\r\n  font-size: medium;\r\n}\r\n\r\n.label {\r\n  width: 20%;  \r\n}\r\n\r\n.texto {\r\n  line-height:26px;\r\n}\r\n\r\n.mat-option {\r\n    margin: 1rem 0;\r\n    overflow: visible;\r\n    line-height: initial;\r\n    word-wrap: break-word;\r\n    white-space: pre-wrap;\r\n    height: unset;\r\n  }\r\n\r\ntable {\r\n  width: 100%;\r\n}\r\n\r\n.filaHorarios {\r\n  height: 35px;\r\n}\r\n\r\ntd.mat-column-star {\r\n  width: 20px;\r\n  padding-right: 8px;\r\n}\r\n\r\nth.mat-column-position, td.mat-column-position {\r\n  padding-left: 8px;\r\n}\r\n\r\n.mat-table-sticky:first-child {\r\n  border-right: 1px solid #e0e0e0;\r\n}\r\n\r\n.mat-table-sticky:last-child {\r\n  border-left: 1px solid #e0e0e0;\r\n}\r\n\r\n.labelForm {\r\n  color: rgba(0,0,0,.54);\r\n  font: 400 11px/20px Roboto,\"Helvetica Neue\",sans-serif;\r\n}\r\n\r\n.alert {\r\n  background-color: yellow;\r\n}\r\n\r\n.msjerror {\r\n  background-color: orangered;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */");
    ...
    function AsignarTurnoDialogComponent(dialog, store, dialogRef, data) {
        ...
        this.store.select(_core_store_selectors_turno_selectors__WEBPACK_IMPORTED_MODULE_4__["selectRespuesta"]).subscribe(function (rta) {
            ...
            if (rta != undefined) {
                ...
                if (((_a = rta === null || rta === void 0 ? void 0 : rta.respuesta) === null || _a === void 0 ? void 0 : _a.codigo) == 400) {
                    _this.alerta = rta.respuesta.mensaje;
                }
                else if (((_b = rta === null || rta === void 0 ? void 0 : rta.respuesta) === null || _b === void 0 ? void 0 : _b.codigo) != 200) {
                    _this.error = rta.respuesta.mensaje;
                }
                else {

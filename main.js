...
/*!*************************************!*\
  !*** ./src/app/core/mocks/mocks.ts ***!
  \*************************************/
/*! exports provided: planMock1, planMock2, planMock3, planMock4, obraSocialMock1, obraSocialMock2, obrasSocialesMocks, centroAtencionMock, centroAtencionesMocks, tokenMock */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
*/
/*
  turnos: Turno[] = [ // reemplazar por servicio
    {codigo:1, fechaHora: new Date('2020/12/20'), estado:1},
    {codigo:2, fechaHora: new Date('2020/12/20'), estado:2},
    {codigo:3, fechaHora: new Date('2020/12/21'), estado:3},
    {codigo:4, fechaHora: new Date('2020/12/23'), estado:4},
    {codigo:1, fechaHora: new Date('2020/12/24'), estado:1},
    {codigo:2, fechaHora: new Date('2020/12/25'), estado:2},
    {codigo:3, fechaHora: new Date('2020/12/25'), estado:3},
    {codigo:4, fechaHora: new Date('2020/12/26'), estado:4},
  ];
*/ 
...
var ServiceService = /** @class */ (function () {
    ...
    ServiceService.prototype.getEspecialidadesProfesionalesFiltradas = function (os, esp) {
        if (this.useMockups) {
            ...
            console.log("getEspecialidadesProfesionalesFiltradas " + endpointB);
...
/*!****************************************************!*\
  !*** ./src/app/core/store/actions/form.actions.ts ***!
  \****************************************************/
/*! exports provided: CLEAR, clear, SET_FECHA_TURNO, setFechaTurno, GET_OBRA_SOCIALES, getObraSociales, SET_OBRA_SOCIALES, setObraSociales, SET_OBRA_SOCIAL_SELECTED, setObraSocialSelected, GET_ESPECIALIDADES, getEspecialidades, SET_ESPECIALIDADES, setEspecialidades, SET_ESPECIALIDAD_SELECTED, setEspecialidadSelected, GET_ESPECIALIDADES_PROFESIONALES, getEspecialidadesProfesionales, SET_ESPECIALIDADES_PROFESIONALES, setEspecialidadesProfesionales, SET_ESPECIALIDAD_PROFESIONAL_SELECTED, setEspecialidadProfesionalSelected, GET_ESPECIALIDADES_PROFESIONALES_FILTRADAS, getEspecialidadesProfesionalesFiltradas, SET_ESPECIALIDADES_PROFESIONALES_FILTRADAS, setEspecialidadesProfesionalesFiltradas, GET_TURNOS, getTurnos, SET_TURNOS, setTurnos, SET_TURNO_SELECTED, setTurnoSelected */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var selectBusquedaTurnos = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(selectFormulario, function (formulario) {
    ...
    if (formulario.fechaSelected != undefined) {
        console.log(formulario.fechaSelected);
        request.fecha =
...
var BusqProfesionalDialogComponent = /** @class */ (function () {
    function BusqProfesionalDialogComponent(store, dialogRef, data) {
        ...
        this.displayedColumnsBusq1 = ['codigo', 'nombreApellido'];
    ...
    BusqProfesionalDialogComponent.prototype.onNoClick = function () {
    ...
    BusqProfesionalDialogComponent.prototype.buscarProfesionales = function () {
        ...
        this.store.select(_core_store_selectors_form_selectors__WEBPACK_IMPORTED_MODULE_5__["selectBusquedaProfesionales"]).subscribe(function (filtrosProfesionales) {
            console.log("filtro " + filtrosProfesionales.os);
    ...
    BusqProfesionalDialogComponent.prototype.busqEspecialidad = function () {
    };
